                        ...
                        <div class="card card-danger">
                            ...
                            <form role="form">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href='<c:url value="/drivings/addNewDriving"/>'
                                               class="btn btn-block btn-success btn-lg"> Dodaj Jazdę
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach begin="0" step="1" end="10" items="${driving}" var="driving"
                                                   varStatus="loop">
                                            <tr>
                                                <td>${loop.count}</td>
                                                <td>${driving.id}</td>
                                                <td>${driving.category}</td>
                                                <td>${driving.employee.firstName} ${driving.employee.lastName}</td>
                                                <td>${driving.vehicle.brand} ${driving.vehicle.model}</td>
                                                <td>${driving.drivingDay}</td>
                                                <td>${driving.drivingBeginTime} - ${driving.drivingEndTime} </td>
                                                <td>${driving.place.name}</td>
                                                <td>
                                                    <!--edit buton -->
                                                    <a href='<c:url value="/driving/editDriving/${driving.id}"/>'
                                                       class="btn btn-success bg-gradient-success"
                                                       style="width: 50px"><i class="fas fa-edit"></i></a>
                                                    <!-- delete buton -->
                                                    <a href="drivings/delete/${driving.id}"
